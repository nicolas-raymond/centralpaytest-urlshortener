...
public class ShortenerServiceTest {
    ...
    @Test
    public void getShortenUrlsFromBase_return_list_of_matching_url() {
        // Given
        try {
            // TODO a real unit test
            tested.shortenUrl("https://www.google.com");
            tested.shortenUrl("https://www.google.com/search?q=tot");
        } catch (Exception e) {
            System.out.println(e.getMessage());
            fail();
        }
        // When
        List<String> result = tested.getShortenUrlsFromBase("https://www.google.com/");
        // Then
        Assert.assertTrue(result.contains("https://shrt.fr/097aio"));
        Assert.assertTrue(result.contains("https://shrt.fr/zfmxz5"));
